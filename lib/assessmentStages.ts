...
export const stages: Array<StageType> = [
  ...
  },
  {
    name: "Post Marking",
    value: "post-mark",
    teacherDescription: "Same as the 'Overview' stage. This is a temporary stage to allow you to check responses and give feedback. You can move to the next stage at any time.",
